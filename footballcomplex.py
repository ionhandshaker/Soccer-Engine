...
red_player=initialize_players(4,4,2)
...
red_player=initialize_skills(4,4,2,red_player)
...
def initialize_positions(a,b,c,player):
    item=[]
    for i in range(11):
        if(i==0):
    ...
    player[i].add_icon(itemx)
    item.append(itemx)
    return player



#red_player=initialize_positions(5,2,3,red_player)
